...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineMongodb_Odm_DefaultConfigurationService()
    {
        ...
        $a->setNamespace('sf2mongodb_default_d07758d0d57d42038f5108074efcfe000724b865b14b334520fb33cdd2e3f72b');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver(new \Doctrine\ODM\MongoDB\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/code/src/Neo/NasaBundle/Document')), 'Neo\\NasaBundle\\Document');
        ...
        $instance->setDocumentNamespaces(array('NasaBundle' => 'Neo\\NasaBundle\\Document'));
    ...
    {
        return $this->services['doctrine_mongodb.odm.default_connection'] = new \Doctrine\MongoDB\Connection('mongodb://symfony28test_mongodb_1:27017', array(), $this->get('doctrine_mongodb.odm.default_configuration'), $this->get('doctrine_mongodb.odm.event_manager'));
    }
    ...
    {
        return $this->services['guzzle'] = new \Guzzle\Http\Client('https://api.nasa.gov/neo/rest/v1');
    }
    ...
    /**
     * Gets the 'neo.document' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Neo\NasaBundle\Document\Neo A Neo\NasaBundle\Document\Neo instance
     */
    protected function getNeo_DocumentService()
    {
        return $this->services['neo.document'] = new \Neo\NasaBundle\Document\Neo();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Neo\NasaBundle\Service\NasaWebService A Neo\NasaBundle\Service\NasaWebService instance
     */
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/code/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/code/vendor/doctrine/mongodb-odm-bundle/Resources/views', 'DoctrineMongoDB');
        $instance->addPath('/code/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/code/src/Neo/NasaBundle/Resources/views', 'Nasa');
        $instance->addPath('/code/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/views', 'Debug');
        $instance->addPath('/code/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath(($this->targetDirs[2].'/Resources/views'));
        $instance->addPath('/code/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('JU5Oq1V5nW0xVO7AMk760gpiOI80HbuysRxSlLhOjjvqLmZwMXTYmsgfjutaDRhv');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/code/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'NasaBundle' => 'Neo\\NasaBundle\\NasaBundle',
            ...
            'kernel.secret' => 'JU5Oq1V5nW0xVO7AMk760gpiOI80HbuysRxSlLhOjjvqLmZwMXTYmsgfjutaDRhv',
